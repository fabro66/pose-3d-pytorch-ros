...
from rviz.tf_pose_broadcaster import pose_rviz, show_2d_pose
from rviz.py_image_talker import image_talker
...
def demo_image(image, model, opt):
  ...
  pose_rviz(preds_3d)                                                                                                                                                                             
  pose_image = show_2d_pose(image, pred, (255, 0, 0))
  image_talker(pose_image)
