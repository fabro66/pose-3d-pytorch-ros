...
import json
import cv2
from lib.utils.image import flip, shuffle_lr
from lib.utils.image import draw_gaussian, adjust_aspect_ratio
...
class MPII(data.Dataset):
  def __init__(self, opt, split):
    ...
    self.num_joints = 16
    # 去除了6盆骨,7胸部,8上颈部,9头顶,12右肩膀,13左肩膀
