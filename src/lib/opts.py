...
class opts():
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='/home/fa/Append/Documents/People_video/playbasketball_kk.mp4',
                             help='path/to/image')
    ...
    self.parser.add_argument('--load_model', default = '/home/fa/project_study/pytorch-pose-hg-3d/models/fusion_3d_var.pth')
